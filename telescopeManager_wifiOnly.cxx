...
char data_send[120] = "GET /orsosa/store.php?word=LetMeIn!&freq=000.0&position=000.0&azimuth_angle=000.0&polar_angle=000.0&distance=000.0";             // Buffer to frequency value storage   
...
//dtostrf() on stdlib.h, to cast a float to char*
    	...
    	data_send[41] = freq_char[0];
		data_send[42] = freq_char[1];
		data_send[43] = freq_char[2];
		data_send[44] = freq_char[3];
        data_send[45] = freq_char[4];
...
void prog_init()      //  Initialization function ...
{
	...
	uart1_send("AT+CWJAP=\"atlasgw\",\"SiLabaLiS\""); _delay_ms(3000);       // Connect to Local Network
    uart_send(uart1_read_cmd());
